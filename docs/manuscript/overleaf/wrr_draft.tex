...
\begin{figure}
    \centering
<<<<<<<< HEAD:docs/manuscript/overleaf/wrr_draft.tex
    \includegraphics[width=0.8\linewidth]{wrr_rmse_bar.pdf}
========
...
\begin{figure}
    \centering
<<<<<<<< HEAD:docs/manuscript/overleaf/wrr_draft.tex
    \includegraphics[width=0.8\linewidth]{wrr_nse_bar.pdf}
========
...
\begin{figure}
    \centering
<<<<<<<< HEAD:docs/manuscript/overleaf/wrr_draft.tex
    \includegraphics[width=\linewidth]{wrr_error_regime_03161000.pdf}
========
